    ...
    sales: z
      .array(
        z.object({
          ...
          paymentCashAmount: z.coerce.number().nonnegative().optional().default(0),
          paymentCardAmount: z.coerce.number().nonnegative().optional().default(0),
          paymentTransferAmount: z.coerce.number().nonnegative().optional().default(0),
